...
public final class MenuSettings {
    ...
    public InventoryType getMenuType(Player player) {
        GuiTypeUtillity type = new GuiTypeUtillity(MenuSettingsAddon.setPlaceholders(player, this.getMenuType()));
    ...
    public static class Builder {
        ...
        public Builder setCommandHandler(final CommandHandler commandHandler) {
