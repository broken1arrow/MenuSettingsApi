...
public enum RequirementType {
	...
	INPUT_NOT_EQUALS_OUTPUT(set("!=")),
	INPUT_EQUALS_OUTPUT(set("==")),
	INPUT_GREATER_THAN_OUTPUT(set(">")),
	INPUT_GREATER_THAN_OR_EQUALS_OUTPUT(set(">=")),
	INPUT_LESS_THAN_OR_EQUALS_OUTPUT(set("<=")),
	INPUT_LESS_THAN_OUTPUT(set("<")),
