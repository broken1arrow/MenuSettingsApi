...
public class CreateItemStack {
     ...
     */
    public static CreateItemStack of(@Nonnull final Object item,@Nonnull final ItemWrapper itemWrapper, @Nonnull final Player player, @Nullable final MenuPlaceholderContext menuPlaceholderContext) {
        CreateItemStack createItemStack;
        String displayName = null;
        List<String> lore = null;
        String icon = MenuSettingsAddon.setPlaceholders(player, itemWrapper.getIcon() != null ? itemWrapper.getIcon() : "", menuPlaceholderContext);
        if (itemWrapper.getDisplayname() != null)
            displayName = MenuSettingsAddon.setPlaceholders(player, itemWrapper.getDisplayname(), menuPlaceholderContext);
        if (itemWrapper.getLore() != null)
            lore = MenuSettingsAddon.setPlaceholders(player, itemWrapper.getLore(), menuPlaceholderContext);
        ...
        if (itemWrapper.getRbg() != null)
            createItemStack.setRgb(MenuSettingsAddon.setPlaceholders(player, itemWrapper.getRbg(), menuPlaceholderContext));
